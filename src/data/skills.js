...
export const devSkills = [
    {
        ...
        items: [
            ...
            { name: "TypeScript", level: "comfortable", note: "used in Seabound Travel" },
    ...
    {
        group: "State & data fetching",
        items: [
            { name: "TanStack Query", level: "comfortable" },
            { name: "Zustand", level: "comfortable" },
            { name: "Axios", level: "confident" },
        ],
    },
    {
        group: "Backend",
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Firebase Auth / Admin", level: "comfortable" },
    ...
    {
        group: "Payments",
        items: [{ name: "Stripe", level: "comfortable" }],
    },
    {
        group: "Design & tools",
        items: [
    ...
    },
    {
        ...
        items: [
            ...
            { name: "ESLint", level: "comfortable" },
            { name: "Prettier", level: "comfortable" },
        ],
    },
    {
        group: "UI & data viz",
        items: [
            { name: "Recharts", level: "comfortable" },
            { name: "React Leaflet", level: "comfortable" },
            { name: "React Hook Form", level: "comfortable" },
        ],
    },
];
